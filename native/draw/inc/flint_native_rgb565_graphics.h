...
#ifndef __FLINT_NATIVE_RGB565_GRAPHICS_H
#define __FLINT_NATIVE_RGB565_GRAPHICS_H
...
inline constexpr NativeMethod rgb565GraphicsMethods[] = {
    ...
    NATIVE_METHOD("drawLine",      "(Lflint/drawing/Color;IIIII)V",                                     NativeRgb565Graphics_DrawLine),
    NATIVE_METHOD("drawRect",      "(Lflint/drawing/Color;IIIII)V",                                     NativeRgb565Graphics_DrawRect),
    NATIVE_METHOD("fillRect",      "(Lflint/drawing/Color;IIII)V",                                      NativeRgb565Graphics_FillRect),
    NATIVE_METHOD("drawRoundRect", "(Lflint/drawing/Color;IIIIIIIII)V",                                 NativeRgb565Graphics_DrawRoundRect),
    NATIVE_METHOD("fillRoundRect", "(Lflint/drawing/Color;IIIIIIII)V",                                  NativeRgb565Graphics_FillRoundRect),
    NATIVE_METHOD("drawEllipse",   "(Lflint/drawing/Color;IIIII)V",                                     NativeRgb565Graphics_DrawEllipse),
    NATIVE_METHOD("fillEllipse",   "(Lflint/drawing/Color;IIII)V",                                      NativeRgb565Graphics_FillEllipse),
    NATIVE_METHOD("drawArc",       "(Lflint/drawing/Color;IIIIIFF)V",                                   NativeRgb565Graphics_DrawArc),
