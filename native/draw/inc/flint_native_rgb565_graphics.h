...
inline constexpr NativeMethod rgb565GraphicsMethods[] = {
    ...
    NATIVE_METHOD("drawRoundRect", "(Lflint/drawing/Color;IIIIIIII)V",                                  NativeRgb565Graphics_DrawRoundRect),
    NATIVE_METHOD("fillRoundRect", "(Lflint/drawing/Color;IIIIIIII)V",                                  NativeRgb565Graphics_FillRoundRect),
    NATIVE_METHOD("drawEllipse",   "(Lflint/drawing/Color;IIII)V",                                      NativeRgb565Graphics_DrawEllipse),
    NATIVE_METHOD("fillEllipse",   "(Lflint/drawing/Color;IIII)V",                                      NativeRgb565Graphics_FillEllipse),
    NATIVE_METHOD("drawArc",       "(Lflint/drawing/Color;IIIIFF)V",                                    NativeRgb565Graphics_DrawArc),
    NATIVE_METHOD("fillArc",       "(Lflint/drawing/Color;IIIIFF)V",                                    NativeRgb565Graphics_FillArc),
    NATIVE_METHOD("drawPolygon",   "(Lflint/drawing/Color;[Lflint/drawing/Point;)V",                    NativeRgb565Graphics_DrawPolygon),
