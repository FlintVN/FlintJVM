...
private:
    void drawCircle(uint32_t color, int32_t x, int32_t y, uint32_t d);
...
public:
    ...
    void drawRect(uint32_t color, int32_t x, int32_t y, int32_t w, int32_t h);
    void fillRect(uint32_t color, int32_t x, int32_t y, int32_t w, int32_t h);
    void drawEllipse(uint32_t color, int32_t x, int32_t y, uint32_t w, uint32_t h);
    void fillEllipse(uint32_t color, int32_t x, int32_t y, uint32_t w, uint32_t h);
    void drawRoundRect(uint32_t color, int32_t x, int32_t y, int32_t w, int32_t h, int32_t r1, int32_t r2, int32_t r3, int32_t r4);
