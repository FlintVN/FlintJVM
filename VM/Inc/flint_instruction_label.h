...
RO_DATA static const void *opcodeRestoreBkpLabels[256] = {
    &&restore_bkp, &&restore_bkp, &&restore_bkp, &&restore_bkp, &&restore_bkp, &&restore_bkp, &&restore_bkp, &&restore_bkp, &&restore_bkp, &&restore_bkp,
    &&restore_bkp, &&restore_bkp, &&restore_bkp, &&restore_bkp, &&restore_bkp, &&restore_bkp, &&restore_bkp, &&restore_bkp, &&restore_bkp, &&restore_bkp,
    &&restore_bkp, &&restore_bkp, &&restore_bkp, &&restore_bkp, &&restore_bkp, &&restore_bkp, &&restore_bkp, &&restore_bkp, &&restore_bkp, &&restore_bkp,
    &&restore_bkp, &&restore_bkp, &&restore_bkp, &&restore_bkp, &&restore_bkp, &&restore_bkp, &&restore_bkp, &&restore_bkp, &&restore_bkp, &&restore_bkp,
    &&restore_bkp, &&restore_bkp, &&restore_bkp, &&restore_bkp, &&restore_bkp, &&restore_bkp, &&restore_bkp, &&restore_bkp, &&restore_bkp, &&restore_bkp,
    ...
    &&restore_bkp, &&restore_bkp, &&restore_bkp, &&restore_bkp, &&restore_bkp, &&restore_bkp, &&restore_bkp, &&restore_bkp, &&restore_bkp, &&restore_bkp,
    &&restore_bkp, &&restore_bkp, &&restore_bkp, &&restore_bkp, &&restore_bkp, &&restore_bkp, &&restore_bkp, &&restore_bkp, &&restore_bkp, &&restore_bkp,
    &&restore_bkp, &&restore_bkp, &&restore_bkp, &&restore_bkp, &&restore_bkp, &&restore_bkp,
};
